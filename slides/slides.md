...
<div class="text-[8px] tracking-[0.3em] uppercase">Subjective Experience</div>
<div class="text-[8px] tracking-[0.3em] uppercase">Objective Data</div>
</div>
...
<style>
@import url('https://fonts.googleapis.com/css2?family=Playfair+Display:wght@700&family=Inter:wght@200;300;400;600&display=swap');
.slidev-layout {
...
<p class="font-bold text-[0.65rem] tracking-[0.2em] uppercase text-[#1D1D1F]">1. The Flaw of Timers</p>
</div>
...
<div class="flex items-center gap-2">
<div class="w-1.5 h-1.5 bg-[#005F73] flex-shrink-0 rounded-full"></div>
<p class="font-bold text-[0.65rem] tracking-[0.2em] uppercase text-[#1D1D1F]">2. The Friction of Journaling</p>
</div>
...
<div class="flex items-center gap-2">
<div class="w-1.5 h-1.5 bg-[#005F73] flex-shrink-0 rounded-full"></div>
<p class="font-bold text-[0.65rem] tracking-[0.2em] uppercase text-[#1D1D1F]">3. The Inaccuracy of Text AI</p>
</div>
...
<div class="flex items-center gap-2">
<div class="w-1.5 h-1.5 bg-[#005F73] flex-shrink-0 rounded-full"></div>
<p class="font-bold text-[0.65rem] tracking-[0.2em] uppercase text-[#1D1D1F]">4. No Task-Emotion Correlation</p>
</div>
...
<span class="text-[0.45rem] font-mono text-black/60 uppercase tracking-widest mt-1 text-center bg-white px-1 relative z-20">Audio Tensor</span>
</div>
...
<span class="text-[0.4rem] font-mono text-black/40 uppercase tracking-wider mt-1 text-center">Feature Extraction</span>
</div>
<carbon:arrow-right class="text-[#005F73]/40 mt-4" />
<div class="flex flex-col items-center gap-1 z-20 w-[6rem]">
...
<span class="text-[0.4rem] font-mono text-black/40 uppercase tracking-wider mt-1 text-center">Continuous 3D Space</span>
</div>
<carbon:arrow-right class="text-[#005F73]/40 mt-4" />
<div class="flex flex-col items-center gap-1 z-20 w-[6rem]">
...
<span class="text-[0.4rem] font-mono text-black/40 uppercase tracking-wider mt-1 text-center">Stress Heuristics</span>
</div>
<carbon:arrow-right class="text-[#005F73]/40 mt-4" />
<div class="flex flex-col items-center gap-1 z-20 w-[4.5rem]">
<div class="w-16 h-16 bg-[#005F73] border border-[#005F73] rounded-xl shadow-[0_5px_15px_rgba(0,95,115,0.3)] flex items-center justify-center text-white text-center leading-tight p-2 font-bold text-[0.55rem] tracking-wide relative z-20">Multi-Modal<br/>Output</div>
</div>
</div>
<!-- Bottom Row: Semantic -->
...
<span class="text-[0.4rem] font-mono text-black/30 uppercase tracking-wider mt-1 text-center bg-white px-1">Speech-to-Text</span>
</div>
...
<span class="text-[0.4rem] font-mono text-black/30 uppercase tracking-wider mt-1 text-center bg-white px-1">Context Sync</span>
</div>
...
<h4 class="font-bold text-[0.65rem] uppercase tracking-widest text-[#1D1D1F]">Acoustic Feature Extraction</h4>
</div>
...
<h4 class="font-bold text-[0.65rem] uppercase tracking-widest text-[#1D1D1F]">Dimensional Emotion (VAD)</h4>
</div>
...
<h4 class="font-bold text-[0.65rem] uppercase tracking-widest text-[#1D1D1F]">Custom Stress Heuristics</h4>
</div>
...
<h4 class="font-bold text-[0.65rem] uppercase tracking-widest text-[#1D1D1F]">Multi-Modal Context</h4>
</div>
...
<h2 class="text-3xl font-serif font-bold text-[#1D1D1F]">Moods & Metrics</h2>
</div>
...
<div class="h-full w-full flex flex-col justify-start px-12 py-10 relative bg-[#F5F5F7]">
<div class="space-y-1 mb-4 w-full">
<h2 class="text-3xl font-serif font-bold text-[#1D1D1F]">Audio Sentiment Analysis</h2>
</div>
<div class="w-full flex-grow relative z-10 h-0">
<SentimentDashboard />
</div>
...
<div class="text-[0.75rem] font-bold uppercase tracking-widest text-[#1D1D1F] m-0 leading-snug">The Enterprise Case<br/><span class="text-[0.6rem] text-black/40 font-normal tracking-normal capitalize">(Preventing Employee Churn)</span></div>
</div>
...
<div class="text-[0.75rem] font-bold uppercase tracking-widest text-[#1D1D1F] m-0 leading-snug">The Self-Quantification Evolution<br/><span class="text-[0.6rem] text-black/40 font-normal tracking-normal capitalize">(Bio-hacking)</span></div>
</div>
...
<div class="text-[0.75rem] font-bold uppercase tracking-widest text-[#1D1D1F] m-0 leading-snug">Clinical & Therapeutic Potential</div>
</div>
...
<h2 class="text-3xl font-serif font-bold text-[#1D1D1F]">Research & References</h2>
</div>
...
<span class="font-bold text-[#4f5c59] uppercase tracking-wider">thelancet.com</span>
<span>&bull;</span>
...
<div class="flex items-center gap-2 text-[0.65rem] text-black/50">
<span class="font-bold text-[#4f5c59] uppercase tracking-wider">who.int</span>
<span>&bull;</span>
...
<div class="flex items-center gap-2 text-[0.65rem] text-black/50">
<span class="font-bold text-[#4f5c59] uppercase tracking-wider">arxiv.org</span>
</div>
</div>
<!-- Item 4 -->
<div class="flex flex-col gap-1">
...
<div class="flex items-center gap-2 text-[0.65rem] text-black/50">
<span class="font-bold text-[#4f5c59] uppercase tracking-wider">openai.com</span>
</div>
</div>
<!-- Item 5 -->
<div class="flex flex-col gap-1">
...
<div class="flex items-center gap-2 text-[0.65rem] text-black/50">
<span class="font-bold text-[#4f5c59] uppercase tracking-wider">researchgate.net</span>
</div>
</div>
<!-- Item 6 -->
<div class="flex flex-col gap-1">
...
<div class="flex items-center gap-2 text-[0.65rem] text-black/50">
<span class="font-bold text-[#4f5c59] uppercase tracking-wider">ncbi.nlm.nih.gov</span>
</div>
</div>
</div>
</div>
